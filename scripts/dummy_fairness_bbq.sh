...
# Dev smoke run for BBQ fairness benchmark.
# Usage:
#   bash scripts/dummy_fairness_bbq.sh
#   GPU=0 METHOD=slice bash scripts/dummy_fairness_bbq.sh

GPU="${GPU:-0}"
METHOD="${METHOD:-vanilla}"
RUN_NAME="${RUN_NAME:-dummy_fairness_bbq_dev01}"
