...
#
# Usage:
#   bash scripts/dummy_fairness_winogender.sh
#   GPU=0 METHOD=slice bash scripts/dummy_fairness_winogender.sh

GPU="${GPU:-0}"
METHOD="${METHOD:-vanilla}"
RUN_NAME="${RUN_NAME:-dummy_fairness_winogender_dev01}"
